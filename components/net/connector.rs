...
impl Connect for HttpConnector {
    ...
    fn connect(&self, dest: Destination) -> Self::Future { //addr: &SocketAddr, local_addr: &Option<IpAddr>, handle: &Option<Handle>, reuse_address: bool) -> Self::Future {
        /* TODO
...
pub fn create_http_client<E: Executor<Box<Future<Error=(), Item=()> + Send + 'static>> + Sync + Send + 'static>(ssl_connector_builder: SslConnectorBuilder, executor: E) -> Client<Connector, WrappedBody> {
